...
ans:deposit(amount) == updates balance, withdraw(amount) == updates balance, printstatement() == prints user information
...
ans:it would be really hard to manage all the info and poor scalability and readability.
