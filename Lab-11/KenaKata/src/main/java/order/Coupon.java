...
/**
 * A discount coupon: a code, a percentage, a cap, a minimum spend, and a last valid day. Given a
 * discountable base and the current day, it returns the discount it grants, or refuses if it has
 * expired or the base falls below its minimum spend.
 */
