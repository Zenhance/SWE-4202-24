...
/**
 * A perishable product. It has weight and needs a refrigerated cold-chain surcharge, is
 * VAT-exempt, may be returned (within a short window) and insured, and earns the platform its
 * lowest commission.
 */
